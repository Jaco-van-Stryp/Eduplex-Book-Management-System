 ...
 */
public class MainAddStudent extends javax.swing.JFrame {

    /**
     * Creates new form MainUserInterface
     */
    public MainAddStudent() {
        initComponents();
    }
    int xMouse;
    int yMouse;
    ...
    private void initComponents() {
        ...
        jLabel61.setText("Student Subjects:");
        jPanel1.add(jLabel61, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 280, 200, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainAddStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainAddStudent().setVisible(true);
            }
        });
    }
